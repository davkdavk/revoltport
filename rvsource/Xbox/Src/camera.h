...
#ifdef _N64
extern CAMERA *AddCamera(REAL x, REAL y, REAL xsize, REAL ysize, long xScSize, long yScSize, long flag);
#else
...
#endif
#ifdef _N64
extern long LoadCameraNodes(FIL *fp);
#endif

#ifdef _N64
extern void DestroyCameraNodes();
extern void ForceCameraChanges();
extern void UpdateCameraChanges(BOOL bChangeRes, BOOL bIsVertical);
#endif
